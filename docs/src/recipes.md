...
| Media | `iso-fetch`, `iso-clean` |
| Seeds | `seed`, `seed-all`, `seed-clean` |
| Hosts | `host-up`, `host-down`, `host-eject`, `console`, `ip`, `ls` |
